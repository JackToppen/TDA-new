...
types <- c(0, 1)    # either a single value or vector
index <- 10    # default index for cell type is last column
...
# generate plots comparing pairs from the specified groups
